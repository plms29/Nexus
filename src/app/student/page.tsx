...
export default function StudentWorkmap() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col">
      ...
      <header className="border-b border-slate-200/90 bg-white/95 backdrop-blur-md px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-xs">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="relative hidden sm:block">
            ...
            <input 
              ...
              className="bg-slate-100 border border-slate-200 text-xs rounded-full pl-9 pr-4 py-2 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 w-56 transition-colors font-semibold"
            />
          </div>
